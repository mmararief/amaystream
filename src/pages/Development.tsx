      ...
      <section className="dev-section">
        ...
        <div className="features-list">
          <div className="feature-item">
            <HiSparkles className="feature-icon" size={24} />
            <div>
              <strong>AI Search</strong>
              <p>
                Cari film berdasarkan deskripsi menggunakan Google Gemini AI
                dengan template pertanyaan
              </p>
            </div>
          </div>
          <div className="feature-item">
            <HiFilm className="feature-icon" size={24} />
            <div>
          ...
          <div className="feature-item">
            <HiSearch className="feature-icon" size={24} />
            <div>
          ...
          <div className="feature-item">
            <HiVideoCamera className="feature-icon" size={24} />
            <div>
          ...
          <div className="feature-item">
            <HiDeviceMobile className="feature-icon" size={24} />
            <div>
          ...
          <div className="feature-item">
            <HiLightningBolt className="feature-icon" size={24} />
            <div>
          ...
          <div className="feature-item">
            <HiLink className="feature-icon" size={24} />
            <div>
      ...
      <section className="dev-section">
        ...
        <div className="api-list">
          <div className="api-item">
            ...
            <p>
              Popular movies, search, detail, credits, similar movies, trending
            </p>
            <a
